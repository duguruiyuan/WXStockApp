...
function ChartLayer() {
	...
	this.getContentHeight = function() {
		// console.log('getHeight*********'+this.getHeight() +'******getBorderWidthTop*****'+ this.getBorderWidthTop() +'******getBorderWidthBottom*****'+ this.getBorderWidthBottom() +'******mPaddingTop*****'+ this.mPaddingTop +'******mPaddingBottom*****'+ this.mPaddingBottom)
