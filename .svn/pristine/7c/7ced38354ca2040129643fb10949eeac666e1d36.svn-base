...
//分时线
		...
		this.lineLayer.setMaxCount(240)//最大点数
...
//画布宽高
		var width = draw.getLengthByRpx(this.canvasWidth)*0.65///根据布局设置
	...
	if (this.mIsInit && obj != null) {
		...
		for (var i = 0; i < values.length; i++) {
			if (this.lineLayer.getValueCount() > 240)
				break
// console.log("MinuteCanvas.prototype.addValues*****"+values[i])
...
// console.log(price+"分时布局添加数据*****"+column)
