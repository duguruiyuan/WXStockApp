...
const debug = false,
    ...
    TESTHTTP = "http://121.41.107.236:8085",//"https://ba7lh5.yiyoudata.com",
    debugUrl = {
        //登录
    ...
    onlineUrl = {
        ...
        //修改个人信息
        query_user_set: apiDomain + "/api/bigname/user_set.do",
        //消费记录（支出）
        query_Consurme: apiDomain + "/api/user/queryConsume.do",
        //消费记录（收入）
        query_Income: apiDomain + "/api/user/queryIncome.do",
        //推荐接口
        ...
        //股票搜索
        stock_search:STOCKAPI+"/stockapi/getequinfo.htm",
        //五档
        stock_five:STOCKAPI+"/stockapi/stockNewData.htm",
        //成交明细
        stock_level1detail:STOCKAPI+"/stockapi/stocklevel1detail.htm",
        //股票板块
        stock_plate:STOCKAPI+"/stockapi/tradeupdownlist.htm",
        //股票板块个股
        stock_plate_trade:STOCKAPI+"/stockapi/tradelist.htm",
        //个股排行
        stock_rank:STOCKAPI+"/stockapi/stockupdownlist.htm",
        //首页指数
        stock_index:STOCKAPI+"/stockapi/stockindexlist.htm",
        //首页指数
        stocks:STOCKAPI+"/stockapi/fmstocks.htm",
        //首页主题按钮
        index_set:apiDomain+"/api/index/set.do",
        //首页热点
        index_hot:apiDomain+"/api/index/hot.do",
        //论股列表
        stockdiscuss_list:apiDomain+"/api/user/stockdiscuss/list.do",
        //添加论股
        stockdiscuss_add:apiDomain+"/api/user/stockdiscuss/add.do",
        //添加论股回复
        stockdiscuss_reply_add:apiDomain+"/api/user/stockdiscuss/reply/add.do",
        //添加点赞
        stockdiscuss_fabulous:apiDomain+"/api/user/stockdiscuss/like.do",
    },
